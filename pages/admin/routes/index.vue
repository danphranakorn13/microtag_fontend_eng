<template>
    <div class="mt-5 mb-10">
        <!-- new task modal -->
        <NewRouteModal :show="showAddTruckModal"  @close="showAddTruckModal=false"></NewRouteModal>
        ...
        <div class="flex flex-wrap items-center justify-between mb-5 space-y-2">
            ...
            <div class="w-full md:w-1/2">
                <h1 class="text-3xl text-center md:text-left font-blod">เส้นทาง</h1>
            </div>
            <!-- Add driver button -->
            <div class="w-full md:block md:w-1/2">
                <button @click="toggleAddTruckModal()" class="float-right w-full px-2 py-1 text-white bg-blue-500 border-2 border-blue-400 shadow-md md:w-auto rounded-3xl text-md">+เส้นทาง</button>
            </div>
        </div>
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr
                      class="text-sm font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-blue-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                    >
                      <th class="hidden px-4 py-3 lg:table-cell">รหัสเส้นทาง</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                        <NuxtLink to="/admin/routes/info">
                          <p class="font-semibold text-blue-500">เส้นไปทางเลี่ยงเมือง</p>
                        </NuxtLink>
                      </td>
                      <td class="px-4 py-3">
                        กรุงเทพ
