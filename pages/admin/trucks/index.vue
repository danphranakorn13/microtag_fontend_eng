<template>
    <div class="mt-5 mb-10">
        <!-- new task modal -->
        <NewTruckModal :show="showAddTruckModal"  @close="showAddTruckModal=false"></NewTruckModal>
        ...
        <div class="flex flex-wrap items-center justify-between mb-5 space-y-2">
            ...
            <div class="w-full md:w-1/2">
                <h1 class="text-3xl text-center md:text-left font-blod">รถบรรทุก</h1>
            </div>
            <!-- Add driver button -->
            <div class="w-full md:block md:w-1/2">
                <button @click="toggleAddTruckModal()" class="float-right w-full px-2 py-1 text-white bg-blue-500 border-2 border-blue-400 shadow-md md:w-auto rounded-3xl text-md">+รถบรรทุก</button>
            </div>
        </div>
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    <tr  v-for="n in 5" :key="n" class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center">
                          ...
                          <NuxtLink to="/admin/trucks/info">
                            <p class="font-semibold">3กจ 1587</p>
