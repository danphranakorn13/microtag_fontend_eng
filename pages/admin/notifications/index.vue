    ...
    <div class="mt-5 mb-10">
        ...
        <div class="flex flex-wrap items-center justify-between mb-5 space-y-2">
            ...
            <div class="w-full md:w-1/2">
                <h1 class="text-3xl text-center md:text-left font-blod">ประวัติการแจ้งเตือน</h1>
            </div>
        </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr class="text-sm font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-blue-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800">
                      ...
                      <th class="px-4 py-3">วัน</th>
                      <th class="hidden px-4 py-3 md:table-cell">เวลา</th>
                    </tr>
                  </thead>
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <tr v-for="(index) in 5" :key="index" class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <button @click="toggleSendMsgModal()" class="flex mx-auto text-xl text-white bg-blue-500 rounded-full hover:bg-blue-300">
...
export default {
    ...
    methods: {
        toggleSendMsgModal(){
            this.showSendMsgModal = !this.showSendMsgModal
        }
    },
}
</script>