<template>
    <div class="mt-5 mb-10">
        <!-- new task modal -->
        <NewJobModal :show="showAddTruckModal"  @close="showAddTruckModal=false"></NewJobModal>
        ...
        <div class="flex flex-wrap items-center justify-between mb-5 space-y-2">
            ...
            <div class="w-full md:w-1/2">
                <h1 class="text-3xl text-center md:text-left font-blod">งาน</h1>
            </div>
            <!-- Add driver button -->
            <div class="w-full md:block md:w-1/2">
                <button @click="toggleAddTruckModal()" class="float-right w-full px-2 py-1 text-white bg-blue-500 border-2 border-blue-400 shadow-md md:w-auto rounded-3xl text-md">+เพิ่มงาน</button>
            </div>
        </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr class="text-sm font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-blue-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800">
                      ...
                      <th class="hidden px-4 py-3 md:table-cell">รหัสคนขับ</th>
                      <th class="hidden px-4 py-3 md:table-cell">รหัสรถบรรทุก</th>
                      <th class="hidden px-4 py-3 md:table-cell">รหัสตู้คอนเทนเนอร์</th>
                      <th class="hidden px-4 py-3 md:table-cell">รหัสเส้นทาง</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <NuxtLink to="/admin/jobs/info">
                          <p class="font-semibold text-blue-500 hover:underline">JBI-0001</p>
                        </NuxtLink>
                      </td>
                      <td class="hidden px-4 py-3 md:table-cell">
                        <NuxtLink to="/admin/drivers/info">
                          <p class="font-semibold text-blue-500 hover:underline">DVI-0001</p>
                        </NuxtLink>
                      </td>
                      <td class="hidden px-4 py-3 md:table-cell">
                        <NuxtLink to="/admin/trucks/info">
                          <p class="font-semibold text-blue-500 hover:underline">TKI-0001</p>
                        </NuxtLink>
                      </td>
                      <td class="hidden px-4 py-3 md:table-cell">
                        <NuxtLink to="/admin/containers/info">
                          <p class="font-semibold text-blue-500 hover:underline">CNI-0001</p>
                        </NuxtLink>
                      </td>
                      <td class="hidden px-4 py-3 md:table-cell">
                        <NuxtLink to="/admin/routes/info">
                          <p class="font-semibold text-blue-500 hover:underline">RTI-0001</p>
                        </NuxtLink>
                      </td>
                      <td class="px-4 py-3">
...
export default {
    ...
    methods: {
        toggleAddTruckModal(){
            this.showAddTruckModal = !this.showAddTruckModal
        }
    },
}
</script>